          ...
          <div class="feed-main-info">
            ...
            <div class="info-detail">
              <div class="schedule-synthesis">
                ...
                <button type="button" class="not-login btn btn-primary btn-lg modal-join-button"><strong>참가하기</strong></button>
              </div>
            </div>
              ...
              <div class="user-info container-md">
                ...
                <div style = "display : flex">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <a class="nav-link dropdown-toggle modal-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                        aria-expanded="false">
                        </a>
...
function renderProperModal($modal: string) {
  ...
  if (modalContainer != null) modalContainer.innerHTML = $modal;
}

function settingRotateEvent() {
  
  const settingButton = document.querySelector('.setting-icon');
  settingButton?.addEventListener('click', () => {
    settingButton.classList.toggle('rotate');
  });

  // document.addEventListener('click', (e) => {
  //   if (settingButton?.classList.contains('rotate')) {
  //     settingButton.classList.remove('rotate');
  //   }
  // });
  // document.addEventListener('click', (e) => {
  //   const target = e.target as Element;
  //   const settingButton = target.closest('.setting-icon');

  //   if (settingButton == null) return;
  //   if (!settingButton?.classList.contains('rotate'))
  //     settingButton.classList.add('rotate');
  //   const settingBtn = document.querySelector('.setting-icon');
  //   if (settingBtn?.classList.contains('rotate'))
